...
const key='pijush-github-projects-v6';
const featured=[
  {repo:'PIJUSH',kind:'PERSONAL',fallback:'Personal website & digital playground'},
  {repo:'Calculator',kind:'PROJECT',fallback:'Interactive calculator built with JavaScript'},
  {repo:'ANIMATION',kind:'EXPERIMENT',fallback:'Animation toolkit for creative frontend experiments'}
];
